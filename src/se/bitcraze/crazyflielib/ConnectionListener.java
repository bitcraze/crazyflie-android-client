...
/**
 * Interface for receiving notifications about the connection
 * status of a {@link Link}.
 */
public interface ConnectionListener {
	...
	/**
	 * Called if the connection fails when it is being established (between the request and connection setup finished).
